...
std::unordered_map<std::wstring, EventInfo> g_EventRegistry = {
	...
	{ L"Wheelman Spree!",											{ EventType::WheelmanSpree,			10 } },
	{ L"Road Hog!",													{ EventType::Roadhog,				10 } },
	{ L"Road Rage!",												{ EventType::Roadrage,				10 } },
	...
	{ L"Second Gunman!",											{ EventType::SecondGunman,			5 } },
	{ L"Sidekick!",													{ EventType::Sidekick,				5 } },
	{ L"Assist Spree!",												{ EventType::AssistSpree,			5 } },
